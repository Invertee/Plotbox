  ...
  const applyPreset = (preset: MapPreset) => {
    ...
    updateOsm({
      ...
      render: {
        ...
        water_treatment: preset === "hydrology" ? "outline-hatch" : project.osm.render.water_treatment,
      },
    });
  };
    ...
    <>
      ...
      <fieldset className="map-control-sections">
        ...
        <details open>
          ...
          <ToggleGrid definitions={TRANSPORT_TOGGLES} project={project} updateFeature={updateFeature} />
        </details>
        ...
        <details>
          ...
          <ToggleGrid definitions={LANDUSE_TOGGLES} project={project} updateFeature={updateFeature} />
          <label>
